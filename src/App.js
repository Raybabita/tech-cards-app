import './App.css'
import TechnologyCardItems from './components/CardItem'
...
const App = () => (
  <div className="tech-app-container">
    <div className="cards-list-container">
      <h1 className="heading">Lear 4.0 Technology</h1>
      ...
      <ul className="cards-list">
        {cardsList.map(eachItem => (
          <TechnologyCardItems cardItemDetails={eachItem} key={eachItem.id} />
        ))}
      </ul>
    </div>
  </div>
